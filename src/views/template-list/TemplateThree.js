  ...
  return (
    <>
      {viewData != 0 && (
        ...
        >
          <CModalBody className="p-0 templateThree-text">
            <CImg
              ...
              height={33}
            ></CImg>
            <CRow className="ml-0 mr-0 mb-3">
              <CCol lg="4" md="4" sm="4" xs="4" className="responsive-template">
                <CRow className="templateThree mr-0 headerColumn"></CRow>
              </CCol>
              <CCol></CCol>
            </CRow>
            <CRow className="ml-0 mr-0">
              <CCol lg="4" md="4" sm="4" xs="4" className="word-break">
                ...
                <CRow className="mb-4" alignHorizontal="center">
                ...
                <CRow className="px-3 mb-4">
                  ...
                  {temp.length > 0 && (
                    <CRow>
                      <CLabel className="subHeading ml-3">Contact</CLabel>
                    </CRow>
                  )}
                  {temp.length > 0 &&
                    temp.map((data, index) => {
                        ...
                        </CLabel>
                        {
                          <CSelect className="borderRadius cursorStyle">
                            ...
                            {filterArray[0].subheadings.length > 0 &&
                              filterArray[0].subheadings.map((data, index) => {
                                return (
                                  <option key={index}>
                          ...
                          filterArray[0].subheadings.map((subData, index) => {
                            return (
                              ...
                              >
                                ...
                                <CLabel className="checkLabel responsive-checkLabel">
                        ...
                        </CLabel>
                        {
                          <CSelect className="borderRadius cursorStyle">
                            ...
                            {filterArray[1].subheadings.length > 0 &&
                              filterArray[1].subheadings.map((data, index) => {
                                return (
                                  <option key={index}>
                                    {data.subheading_name}
                                  </option>
              ...
              <CCol lg="8" md="8" sm="8" xs="8" className="mb-3 word-break">
                <div className="ml-3 mr-3 pb-3 responsive-column">
            ...
            <CRow className="ml-0 mr-0">
              <CCol></CCol>
              <CCol lg="8" md="8" sm="8" xs="8">
                <CRow className="templateThree resposive-bottom ml-0"></CRow>
              </CCol>
            </CRow>
          </CModalBody>
        </CModal>
