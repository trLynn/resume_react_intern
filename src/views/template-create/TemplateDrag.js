...
const TemplateDrag = (props) => {
  let { data, remove, edit, item, updateStatus } = props;
  return (
    <>
      {data.map((data, index) => {
        return (
                          ...
                          {data.subheadings.map((multiChoice, index) => {
                            return (
                              <CCol lg="2" key={index} className="radio-label">
                                ...
                                <CLabel className="RadioLabel" style={{wordBreak: "break-word",paddingLeft:"5px"}}>
                                  {multiChoice}
                                </CLabel>
                              </CCol>
                            );
                      ...
                      <CRow>
                        <CCol lg="6" sm="10" xs="11" md="10">
                          <CInputGroup className="mb-3">
                            <CLabel className="userform-attach" htmlFor="inputGroupFile02">
                              Pick File
                            </CLabel>
